...
The URL I<http://www.example.com/perl/test.pl> will be mapped to
...
used, C<PerlModule> and C<PerlRequire> are the two mod_perl
...
A nifty mod_info module displays a complete server configuration in
the browser. In order to use it you have compile it in or load as an
