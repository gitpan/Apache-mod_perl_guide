...
=head1 Correct Headers - A quick guide for mod_perl users
...
increase the performace of your site.  Especially if you use Squid in
...
this argument first.
  ...
  $Mtime ||=
    Date::Parse::str2time(substr q$Date: 2000/05/26 22:13:55 $, 6);
...
=head2 3.) Avoiding dealing with them
...
You're reading revision $Revision: 1.11 $ of this document, written on
$Date: 2000/05/26 22:13:55 $

=head1 AUTHOR

Andreas Koenig with helpful corrections, addition, comments from Ask
Bjoern Hansen <ask@netcetera.dk>, Frank D. Cringle
<fdc@cliwe.ping.de>, Eric Cholet <cholet@logilune.com>, Mark Kennedy
<mark.kennedy@gs.com>, Doug MacEachern <dougm@pobox.com>, Tom Hukins
<tom@eborcom.com>, Wham Bang <wham_bang@yahoo.com> and many others.
