...
you should look at C<Apache::VMonitor> as it deployes a big part of
...
overriden by C<Apache::exit()> if used in conjunction with
...
[META: Anyone can explain why localization doesn't work?]
...
I<text/plain>. The gets ready to ignore the child, to avoid zombies
