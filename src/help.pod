...
directly to me at
sbekman@iname.com?subject=mod_perl%20guide%20corrections.  If you are
...
=item * mod_perl mailing list

The Apache/Perl mailing list (modperl@apache.org) B<is available for
mod_perl users and developers to share ideas, solve problems and
discuss things related to mod_perl and the Apache::* modules.> To
subscribe to this list, send mail to majordomo@apache.org
with empty C<Subject> and with C<Body>:
