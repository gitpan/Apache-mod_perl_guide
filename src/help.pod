...
section, and still don't have the answers/information needed, please
ask the apache/mod_perl mailing list to help. But please, first try to
browse the mailing list archive.  Most of the time you will find the
answer to your questions by searching the mailing archive, since it is
most likely that someone else has already encountered the same problem
...
answer the same question more than once. It does not mean that you
should avoid asking questions. But you should not abuse the available
help and should B<RTFM> before you call for B<HELP>. (Remember the
...
will be answered on the list. Thank you!>
...
email to modperl-unsubscribe@apache.org . Use the modperl@apache.org
address to post to the list.

A B<searchable> mod_perl mailing list archive is available at
...
modperl-cvs-unsubscribe@apache.org .  Use the modperl-cvs@apache.org
address to post to the list.
...
=item * Limit the number of Apache children
that can be servicing a requested resource at one time.
