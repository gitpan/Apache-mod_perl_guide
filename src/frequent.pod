...
META: Not clear on last sentence -- are you saying that if you have a static version people I<will> have to comment out lines or they won't? If they will then the text is correct, if the won't then it should be: "...server with anything, and we shouldn't even need to comment out lines..."

Also see the section" L<mod_perl Deployment
