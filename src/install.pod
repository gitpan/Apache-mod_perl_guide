...
Another approach is to configure C<Apache::Status> as explain on page
XXX of Chapter YYY and run http://localhost/perl-status?hooks to check
for enabled hooks.
...
Now fetch the URL C<http://www.example.com:8080/perl/test.pl> (replace
