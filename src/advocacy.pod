...
little extra time and resource into choosing the right tool for the job.
The extra quality and manageability of your site along with your ability to
deliver new and improved functionality of high quality and in good time will
prove the superiority of using solid flexible tools.
...
to say: `Go with it'. Of course since the moment I did it, I have had to
provide all the support for other developers, which is why I took
time to learn it in first place (and why this guide was created!).
...
closely and sees much worse than expected progress, you might be told
to "forget it" and never give mod_perl a second chance.
...
Forking and loading (unless code is shared) of C/C++ optimized CGI
programs produces an overhead
