...
# stas: made all levels one more for correct TOC generation in html2ps
    $level++;
...
#    $OUT .= "$HR\n" unless $listlevel || $top;
    $OUT .= "<CENTER><H$level>"; # unless $listlevel;
    ...
    $OUT .= "</H$level></CENTER>"; # unless $listlevel;
    $OUT .= "\n";
